...
pageMod.PageMod({
    include: "resource://jid1-sh1e6mmytbsebw-at-jetpack\/data\/prefs.html",
...
function getButtonIcon() {
    return ss.storage.enabled ?  data.url("icon.png") : data.url("icon-disabled.png")
}
